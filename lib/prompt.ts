...
- "steps": the working, in order. 3 to 10 of them. They are set as ONE continuous piece of working — sentence, line, sentence, line, down the page — so write them to be read straight through, each one carrying on from the line above it.
  ...
  - **No titles and no step labels.** Not "Step 3", not "Factoring the denominator:", not a heading of any kind — nothing is set as a section on this page. Say the thing itself: "The denominator factors, which is what makes the partial fractions possible." A label over a sentence is the same sentence said twice.
